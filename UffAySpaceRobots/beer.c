...
void beer() {
	...
	SDL_Texture *pad = loadImage("images/room3/ratsel/beer.bmp", rendererPopup);
	SDL_Texture *ascii = loadImage("images/room3/ratsel/beer_ascii.bmp", rendererPopup);
	SDL_Texture *error = loadImage("images/room3/ratsel/beer_idiot.bmp", rendererPopup);
